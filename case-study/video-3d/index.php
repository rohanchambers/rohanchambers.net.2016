...
$browserTitle = '3D Virtual House Version 2. | RohanChambers.net';
	...
	<div id="content" class="clearfix">
		<section id="case-study">
			<div id="left-col">
				<h1>Case study</h1>
				<ul id="controls">
					<li><a href="../freelance-work/html-5.php" class="go-back"></a></li>
					<li><a href="/portfolio.php" class="go-all"></a></li>
					<li><a href="../video-3d/virtual-house-ver-1.php" class="go-next"></a></li>
				</ul>
				<div class="hr"></div>	
				<h2>3D Virtual House Version 2.</h2>
			...
			<div id="right-col">    
                    <ul>
                    	<li><img src="../../img/pages/case-study/video-3d/3Dhouse.jpg" alt="3D Virtual House Version 2." width="580" height="464" /></li>
						<li>
							<h3>3D virtual house video:</h3>
                    	...
                    	<li><img src="../../img/pages/case-study/video-3d/3Dhouse-3.jpg" alt="3D Virtual House Version 2." width="580" height="464" /></li>
                    	<li><img src="../../img/pages/case-study/video-3d/3Dhouse-4.jpg" alt="3D Virtual House Version 2." width="580" height="464" /></li>
                    	<li><img src="../../img/pages/case-study/video-3d/3Dhouse-5.jpg" alt="3D Virtual House Version 2." width="580" height="464" /></li>
                    	<li><img src="../../img/pages/case-study/video-3d/3Dhouse-2.jpg" alt="3D Virtual House Version 2." width="580" height="464" /></li>
                    </ul>
        	</div><!-- /#right-col -->
		</section><!-- /section -->						
	</div><!-- /content -->
