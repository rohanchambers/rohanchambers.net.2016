...
$browserTitle = 'Honda Jazz Facebook Development | RohanChambers.net';
		...
		<section id="case-study">
			<div id="left-col">
				...
				<ul class="case-study-details">
					...
					<li><strong>Technologies:</strong> FBML,XHTML, CSS</li>				
					...
					<li><strong>View site:</strong> <a href="http://www.facebook.com/hondacarsuk?sk=app_4949752878" class="targetBlank">www.facebook.com/hondacarsuk</a></li>
				</ul>
				<div class="hr"></div>	
				<ul class="case-study-details">
			...
			<div id="right-col">
				<ul>
					<li><img src="../../img/pages/case-study/honda/honda-jazz.jpg" alt="Honda Jazz Facebook" width="580" height="883" /></li>
				</ul>
			</div><!-- /#right-col -->
		</section><!-- /section -->						
	</div><!-- /content -->
